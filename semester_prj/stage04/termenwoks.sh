...
do
	...
	if [ $button_state = 1 ]
	then
		dt_temp=$(sudo ./rangefinder_hcsr04_IlorDash -q 10000000 range_val)
		...
		min_len_temp=$(sudo ./rangefinder_hcsr04_IlorDash -q 10000000)
